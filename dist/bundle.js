...
var Worm = function Worm() {
  ...
  var counter = 0;
  return { gender: gender, attr: attr, pos: pos, uniqueName: uniqueName, toString: toString, counter: counter };
};

module.exports = Worm;

},{"../App/MaximumValues":20,"uuid":18}],22:[function(require,module,exports){
'use strict';
...
var normalizeWormsThatHaveCrashed = _require.normalizeWormsThatHaveCrashed;
...
// moveWorms(worms)
//   .forEach(worm => canvasContext.fillRect(worm.pos.x, worm.pos.y, worm.pos.width, worm.pos.height))

},{"./App/Crash":19,"./Model/Worm":21,"redux":12}]},{},[22]);
